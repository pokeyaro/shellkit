...
from .reminder import REMINDER_TEXTS, INFO_NORMAL, INFO_CRITICAL

from shell.environs.accessors import get_lang
from shell.environs.constants import DEFAULT_LANG
